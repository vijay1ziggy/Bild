...
import vijay.bild.fragments.IProfile;
import vijay.bild.fragments.ImageListFragment;
        ...
        IProfile
{
    ...
    private void retrieveProfileImage(){
        ...
        int avatar = 0;
        try{
            avatar = Integer.parseInt(((UserClient)getApplicationContext()).getUser().getImageurl());
    ...
    public void onImageSelected(int resource) {
        ...
        user.setImageurl(String.valueOf(resource));

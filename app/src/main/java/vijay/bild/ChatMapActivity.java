...
import vijay.bild.R;
import vijay.bild.UserClient;
import vijay.bild.Adapter.ChatroomRecyclerAdapter;
import vijay.bild.model.Chatroom;
import vijay.bild.model.User;
import vijay.bild.model.UserLocation;
import vijay.bild.services.LocationService;
...
import static vijay.bild.Constants.ERROR_DIALOG_REQUEST;
import static vijay.bild.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static vijay.bild.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;


public class ChatMapActivity extends AppCompatActivity implements
...
//        this.startService(serviceIntent);
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O){
                ...
                ChatMapActivity.this.startForegroundService(serviceIntent);
            }else{
    ...
    private boolean isLocationServiceRunning() {
        ...
        for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)){
            if("vijay.bild.services.LocationService".equals(service.service.getClassName())) {
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(ChatMapActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(ChatMapActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
...
//        mDb.setFirestoreSettings(settings);
    ...
    private void navChatroomActivity(Chatroom chatroom){
        Intent intent = new Intent(ChatMapActivity.this, ChatroomActivity.class);
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(ChatMapActivity.this, "Enter a chatroom name", Toast.LENGTH_SHORT).show();
                }
            }
        });
